...
public class SingleThreadExecutor implements ExecutorService {
    ...
    private final InternalRejectedHandler rejectedHandler;
    ...
    public SingleThreadExecutor(ThreadFactory threadFactory, BlockingQueue<Runnable> taskQueue, InternalRejectedHandler rejectedHandler) {
